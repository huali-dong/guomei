		...
		window[fnName] = function(magnifierAttr){
			...
			_this.eqImg = function(){
				var img = new Image();
					...
					// src = "../../../img/detail/bigpic" + magnifier.index + ".jpg";
					
				// var imgurl = localStorage.getItem("pid");
					// console.log(imgurl);
				src = magnifier.imgurl;
				img.src = src;
				
				//承载容器的宽高
				//console.log(magnifier.width);
				...
				function imgLoadEnd(){
					...
					// _this.view.empty().append("<img src=../../../img/detail/bigbigpic" +magnifier.index+".jpg>");
